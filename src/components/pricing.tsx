        ...
        <section className="container mx-auto max-w-full md:max-w-[1100px] py-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <Card>
                    ...
                    <CardContent>
                        <p className="text-2xl font-bold">Ab 20 € pro Stunde</p>
                        ...
                        <div className="mt-6">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-sm">
                                ...
                                <li>
                                    Nachbearbeitung kleinerer und mittelgroßer
                                    Änderungen
                                </li>
                                <li>Durchführung von Updates</li>
                                <li>
                                    Wiederkehrende, aber unregelmäßige Design-
                                    und Layoutarbeiten
                                </li>
                                <li>
                                    Kurzfristige Anpassungen und
                                    Fehlerbehebungen
                                </li>
                            </ul>
                        </div>
                    ...
                    <CardFooter>
                        <Link
                            href="mailto:hello@emiliansch.dev"
                            className="w-full"
                        >
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <ul className="mt-4 space-y-2">
                            ...
                            <li>
                                Ohne Risiko über einen vereinbarten Zeitraum
                            </li>
                        ...
                        <div className="mt-6">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-sm">
                                ...
                                <li>
                                    Erstellung eines kompletten Webauftritts
                                </li>
